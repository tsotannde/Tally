...
extension InitialLoginViewController
{
    ...
    private func constructUserInterface()
    {
       ...
       // let googleButton = makeGoogleButton()
        ...
        // Buttons stack
        let buttonStack = UIStackView(arrangedSubviews: [emailButton, appleButton])
        ...
        NSLayoutConstraint.activate([
           ...
           // googleButton.heightAnchor.constraint(equalToConstant: DesignSystem.AppConstants.LoginUI.buttonHeight),
